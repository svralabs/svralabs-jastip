...
export default function Catalog1() {
  return (
    <div className="min-h-screen bg-[#fff8ef] text-[#1e1b13] font-sans antialiased">
...
<div className="absolute inset-0 opacity-10 pointer-events-none" style="background-image: radial-gradient(#000 1px, transparent 0); background-size: 10px 10px;"></div>
...
<span className="material-symbols-outlined" data-icon="import_contacts" style="font-variation-settings: 'FILL' 1;">import_contacts</span>
