...
<span className="material-symbols-outlined text-primary-container bg-on-background rounded-full p-1 text-[16px]" style="font-variation-settings: 'FILL' 1;">info</span>
